...
## Features
- **Zero-Friction Engine**: Automatically advances on typing; when the sequence finishes, a new 3–6 character sequence appears in 0ms without any mouse clicks or delays.
...
- **Arbitrary & Fixed Sequence Lengths**: Dual min/max stepper controls allowing custom length ranges (default 3–6 random) or fixed lengths (`Min === Max`), dynamically capped to fit your screen.
